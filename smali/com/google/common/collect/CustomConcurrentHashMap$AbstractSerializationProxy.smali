...
.method constructor <init>(Lcom/google/common/collect/CustomConcurrentHashMap$Strength;Lcom/google/common/collect/CustomConcurrentHashMap$Strength;Lcom/google/common/base/Equivalence;Lcom/google/common/base/Equivalence;JJIILcom/google/common/collect/hb;Ljava/util/concurrent/ConcurrentMap;)V
    ...
    iput-object p11, p0, Lcom/google/common/collect/CustomConcurrentHashMap$AbstractSerializationProxy;->evictionListener:Lcom/google/common/collect/hb;
...
.method readMapMaker(Ljava/io/ObjectInputStream;)Lcom/google/common/collect/MapMaker;
    ...
    iget-object v1, p0, Lcom/google/common/collect/CustomConcurrentHashMap$AbstractSerializationProxy;->keyStrength:Lcom/google/common/collect/CustomConcurrentHashMap$Strength;

    invoke-virtual {v0, v1}, Lcom/google/common/collect/MapMaker;->setKeyStrength(Lcom/google/common/collect/CustomConcurrentHashMap$Strength;)Lcom/google/common/collect/MapMaker;

    move-result-object v0

    iget-object v1, p0, Lcom/google/common/collect/CustomConcurrentHashMap$AbstractSerializationProxy;->valueStrength:Lcom/google/common/collect/CustomConcurrentHashMap$Strength;

    invoke-virtual {v0, v1}, Lcom/google/common/collect/MapMaker;->setValueStrength(Lcom/google/common/collect/CustomConcurrentHashMap$Strength;)Lcom/google/common/collect/MapMaker;

    move-result-object v0

    iget-object v1, p0, Lcom/google/common/collect/CustomConcurrentHashMap$AbstractSerializationProxy;->keyEquivalence:Lcom/google/common/base/Equivalence;

    invoke-virtual {v0, v1}, Lcom/google/common/collect/MapMaker;->privateKeyEquivalence(Lcom/google/common/base/Equivalence;)Lcom/google/common/collect/MapMaker;

    move-result-object v0

    iget-object v1, p0, Lcom/google/common/collect/CustomConcurrentHashMap$AbstractSerializationProxy;->valueEquivalence:Lcom/google/common/base/Equivalence;

    invoke-virtual {v0, v1}, Lcom/google/common/collect/MapMaker;->privateValueEquivalence(Lcom/google/common/base/Equivalence;)Lcom/google/common/collect/MapMaker;

    move-result-object v0

    iget v1, p0, Lcom/google/common/collect/CustomConcurrentHashMap$AbstractSerializationProxy;->concurrencyLevel:I

    invoke-virtual {v0, v1}, Lcom/google/common/collect/MapMaker;->c(I)Lcom/google/common/collect/MapMaker;

    move-result-object v0

    iget-object v1, p0, Lcom/google/common/collect/CustomConcurrentHashMap$AbstractSerializationProxy;->evictionListener:Lcom/google/common/collect/hb;

    invoke-virtual {v0, v1}, Lcom/google/common/collect/MapMaker;->evictionListener(Lcom/google/common/collect/MapEvictionListener;)Lcom/google/common/collect/GenericMapMaker;

    iget-wide v1, p0, Lcom/google/common/collect/CustomConcurrentHashMap$AbstractSerializationProxy;->expireAfterWriteNanos:J
    ...
    :cond_0
    iget-wide v1, p0, Lcom/google/common/collect/CustomConcurrentHashMap$AbstractSerializationProxy;->expireAfterAccessNanos:J
    ...
    :cond_1
    iget v1, p0, Lcom/google/common/collect/CustomConcurrentHashMap$AbstractSerializationProxy;->maximumSize:I
