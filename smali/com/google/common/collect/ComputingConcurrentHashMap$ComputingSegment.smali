...
# virtual methods
.method final compute(Ljava/lang/Object;ILcom/google/common/collect/ht;Lcom/google/common/collect/cl;)Ljava/lang/Object;
    .locals 6
    ...
    :try_start_1
    invoke-virtual {p4, p1, p2}, Lcom/google/common/collect/cl;->a(Ljava/lang/Object;I)Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {p0, p1, p2, p4}, Lcom/google/common/collect/ComputingConcurrentHashMap$ComputingSegment;->clearValue(Ljava/lang/Object;ILcom/google/common/collect/if;)Z
...
.method final getOrCompute(Ljava/lang/Object;ILcom/google/common/base/ae;)Ljava/lang/Object;
    .locals 11
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lcom/google/common/collect/ComputingConcurrentHashMap$ComputingSegment;->getEntry(Ljava/lang/Object;I)Lcom/google/common/collect/ht;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {p0, v1}, Lcom/google/common/collect/ComputingConcurrentHashMap$ComputingSegment;->getLiveValue(Lcom/google/common/collect/ht;)Ljava/lang/Object;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {p0, v1}, Lcom/google/common/collect/ComputingConcurrentHashMap$ComputingSegment;->recordRead(Lcom/google/common/collect/ht;)V
    :try_end_0
    ...
    invoke-interface {v0}, Lcom/google/common/collect/if;->b()Z
    ...
    invoke-interface {v5}, Lcom/google/common/collect/ht;->getKey()Ljava/lang/Object;

    move-result-object v9

    invoke-interface {v5}, Lcom/google/common/collect/ht;->getHash()I
    ...
    invoke-interface {v5}, Lcom/google/common/collect/ht;->getValueReference()Lcom/google/common/collect/if;

    move-result-object v1

    invoke-interface {v1}, Lcom/google/common/collect/if;->b()Z
    ...
    invoke-direct {v1, p3}, Lcom/google/common/collect/cl;-><init>(Lcom/google/common/base/ae;)V

    if-nez v5, :cond_7

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/common/collect/ComputingConcurrentHashMap$ComputingSegment;->newEntry(Ljava/lang/Object;ILcom/google/common/collect/ht;)Lcom/google/common/collect/ht;

    move-result-object v0

    invoke-interface {v0, v1}, Lcom/google/common/collect/ht;->setValueReference(Lcom/google/common/collect/if;)V
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/google/common/collect/ComputingConcurrentHashMap$ComputingSegment;->compute(Ljava/lang/Object;ILcom/google/common/collect/ht;Lcom/google/common/collect/cl;)Ljava/lang/Object;
    :try_end_3
    ...
    invoke-virtual {v10, v5}, Lcom/google/common/collect/MapMakerInternalMap;->isExpired(Lcom/google/common/collect/ht;)Z
    ...
    :cond_5
    :try_start_6
    invoke-virtual {p0, v5}, Lcom/google/common/collect/ComputingConcurrentHashMap$ComputingSegment;->recordLockedRead(Lcom/google/common/collect/ht;)V
    :try_end_6
    ...
    :cond_6
    :try_start_8
    invoke-interface {v5}, Lcom/google/common/collect/ht;->getNext()Lcom/google/common/collect/ht;
    ...
    :cond_7
    invoke-interface {v5, v1}, Lcom/google/common/collect/ht;->setValueReference(Lcom/google/common/collect/if;)V
    :try_end_8
    ...
    invoke-static {v0, v4}, Lcom/google/common/base/aq;->b(ZLjava/lang/Object;)V
